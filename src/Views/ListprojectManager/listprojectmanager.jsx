...
export default () => {
  ...
  useEffect(() => {
    axiosApi.get("http://localhost:5000/projects/manager/" + id).then((res) => {
  ...
  console.log(auth?.user?._id, "IIIIDDDDDDDDDDDDDDD MANAGER");
      ...
      >
        ...
        <Select
          ...
          /*    value={list.filter(
                                            ...
                                            (option) => option.value === String(liststatus?.status)
                                        )}  */
        ...
        <Select
          ...
          // onChange={(e)=>setselectedproject({...selectedproject,manager:e?.value})}
          //styles={styleData}
          options={list}
        />
      </Modal>
